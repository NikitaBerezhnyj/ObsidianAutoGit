# Contributing to Obsidian Auto Git

Thank you for your interest in contributing to **Obsidian Auto Git**!  
We appreciate every contribution, big or small, and your efforts help improve the project for everyone.

## How to Contribute

There are several ways you can contribute to **Obsidian Auto Git**:
...
- If you have ideas for improving **Obsidian Auto Git**, please describe them in a new issue.
...
- Ensure your code follows the existing style and conventions of **Obsidian Auto Git**.

### 4. Code Review

- Review open pull requests when possible.
- Provide constructive feedback to help maintain the quality of **Obsidian Auto Git**.
...
Your contributions make **Obsidian Auto Git** better for everyone.  
Even small fixes, documentation updates, or suggestions are highly valued.  
We look forward to your contributions and appreciate your help in making **Obsidian Auto Git** a stronger, more reliable project.
